...
source(here("Data/procedural_justice-master/src/aux/cumulative.R"))
...
ggsave(figure_s7, filename = here("Data/procedural_justice-master/products/figures/figure_s7.pdf"),
       width = 10, height = 4.2, device = cairo_pdf)

# save
save.image(here("Data/procedural_justice-master/products/rdata/10_termination.RData"))
