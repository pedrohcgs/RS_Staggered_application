...
load(here("Data/procedural_justice-master/products/rdata/3_estimation.RData"))
...
# save
save.image(here("Data/procedural_justice-master/products/rdata/4_placebo.RData"))
