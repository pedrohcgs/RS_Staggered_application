...
ggsave(figure_s6, filename = here("Data/procedural_justice-master/products/figures/figure_s6.pdf"),
       width = 8, height = 9, device = cairo_pdf)

# save
save.image(here("Data/procedural_justice-master/products/rdata/9_force.RData"))
