...
source(here("Data/procedural_justice-master/src/aux_files/units.R"))
...
# write figures
ggsave(figure_s1, filename = here("Data/procedural_justice-master/products/figures/figure_s1.pdf"),
       width = 10, height = 9.2, device = cairo_pdf)
ggsave(figure_s2, filename = here("Data/procedural_justice-master/products/figures/figure_s2.pdf"),
       width = 10, height = 6.2, device = cairo_pdf)
ggsave(figure_s3, filename = here("Data/procedural_justice-master/products/figures/figure_s3.pdf"),
       width = 8, height = 4, device = cairo_pdf)
ggsave(figure_s4, filename = here("Data/procedural_justice-master/products/figures/figure_s4.pdf"),
